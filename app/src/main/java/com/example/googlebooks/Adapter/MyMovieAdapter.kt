...
class MyMovieAdapter(private val context: Context, private val movieList: MutableList<VolumeInfo>):
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_name.text = movieList[position].title
        holder.txt_team.text = movieList[position].publisher
        holder.txt_createdby.text = movieList[position].authors[0]
    }
